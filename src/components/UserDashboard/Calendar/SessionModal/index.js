      ...
      >
        ...
        <div className="w-full flex flex-col justify-center items-center gap-4">
          ...
          <div className="w-full flex flex-col justify-start items-start gap-3">
            ...
            <button
              type="button"
              className={`${styles.primary_button} md:!w-[50%] !font-[700] flex justify-center items-center !h-[48px] !text-[14px] !px-[10px]`}
              onClick={primaryBtnClick}
            >
              Meet with `{`Service Provider`}`
            </button>
          </div>
          <TextAreaField
            label={"Additional notes from {SP-Name}"}
            placeholder={
