  ...
  const stepsData = [
    {
      ...
      content: "Customer already paid for your services.",
      active: true,
    },
    {
      title: "Session",
      content: "Create a schedule session for your customer.",
      active: true,
    },
    {
      title: "Complete!",
      content: "Yeay! You finished your sessions with your customer!",
      active: true,
    },
  ];
      ...
      >
              ...
              <div className="w-full border border-[#E7E7E7] rounded-[12px] p-5">
                <div className="flex justify-start items-center gap-4">
                  ...
                  <div className="flex flex-col justify-start items-start gap-1">
                    ...
                    <span className="text-[14px] text-[#666666] font-poppins font-[400]">$10.00/h</span>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div key={index} className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col justify-start items-start gap-2">
                    ...
                    {activeIndices.length >= 2 && index == 1 && (
                      <button
                        type="button"
                        className={`${styles.primary_button} w-full !font-[700] font-poppins flex justify-center items-center !h-[48px] !text-[14px] !mb-3`}
                        onClick={primaryBtnClick}
                      >
                        {activeIndices.length == 2 ? "Add Schedule" : "Completed"}
                      </button>
                    )}
                  </div>
                </div>
        ...
        <div className="w-full flex flex-col justify-center md:flex-row md:justify-end items-center gap-4 mt-4">
          ...
          {activeIndices.length === 3 && (
            <button
              type="button"
              className={`${styles.primary_button} md:!w-[25%] lg:!w-[20%] !font-[700] font-poppins flex justify-center items-center !h-[48px] !text-[14px] !px-[10px]`}
              onClick={primaryBtnClick}
            >
              Completed
            </button>
