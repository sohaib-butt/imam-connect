...
const index = () => {
  const galleryCards = [1, 2, 3, 4, 5, 6];
  return (
    <div className="w-full flex flex-col gap-4 justify-start items-start p-[24px] md:pt-[40px] md:pb-[40px] md:px-[80px] lg:pt-[40px] lg:pb-[80px] lg:px-[160px] bg-white">
      ...
      <div className="flex flex-wrap justify-start items-center gap-3">
        {galleryCards?.map((g, index) => (
          <div
            key={index}
            className="w-[312px] md:w-[360px] h-[277px] md:h-[320px] relative cursor-pointer"
          >
            <Image src="assets/images/gallery_image.svg" alt="Profile" className="w-full h-full rounded-[11px] md:rounded-[12px]" fill/>
            <div className="absolute p-[14px] md:p-[16px] bottom-0 w-full rounded-bl-[11px] rounded-br-[11px] md:rounded-bl-[12px] md:rounded-br-[12px] bg-gradient-to-t from-[#2A282F] to-[#2A282F00] flex justify-start items-center gap-3">
              <Image src="assets/images/gallery_profile.svg" alt="Profile" width={48} height={48} />
